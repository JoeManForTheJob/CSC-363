...
# Insert Constant Folding Here

folded_program = constant_folding(program) #will fold the constants, unless there is a varref in which case do nothing

instructions = codegenerator(folded_program)
